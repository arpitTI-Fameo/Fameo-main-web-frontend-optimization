// 'use client';
// // components/account/InviteModal.js
// // ─────────────────────────────────────────────────────────────────────────────
...
// const BASE_URL = 'https://fameo.vip/join?ref=';
...
//   const link = coupon ? `${BASE_URL}${coupon.code}` : `${BASE_URL}…`;
//   const message = `Join me on Fameo — here's ${tier?.discount}% off your first plan: ${link}`;
