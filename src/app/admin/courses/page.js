...
// // // const CATEGORIES = ["Growth","Monetization","Content","Analytics","Mindset"];
...
// // //     if (course._static) {
// // //       showToast("Click 'Save to DB' first, then you can publish/unpublish", false);
// // //       return;
// // //     }
// // //     try {
// // //       const data = await api.patch(`/courses/admin/${course._id}/toggle-publish`, {});
// // //       setCourses(cs => cs.map(c =>
// // //         c._id === course._id ? { ...c, isPublished: data?.data?.isPublished } : c
// // //       ));
...
// // //     if (course._static) { showToast("Save to DB first", false); return; }
// // //     try {
// // //       const data = await api.patch(`/courses/admin/${course._id}/feature`, {});
// // //       setCourses(cs => cs.map(c =>
// // //         c._id === course._id ? { ...c, isFeatured: data?.data?.course?.isFeatured } : c
// // //       ));
...
// // //   // Migrate static → DB
// // //   const migrateToDb = async (course) => {
// // //     try {
...
// // //         isPublished:  false,
// // //       });
// // //       showToast("Course saved to database ◉");
// // //       load();
// // //     } catch (e) {
// // //       showToast(e.message?.includes("already exists") ? "Already in DB — refresh page" : "Migration failed", false);
// // //       load(); // refresh anyway in case it exists
// // //     }
// // //   };
...
// // //                   ◈ Chapter and lesson editing (add/remove/reorder chapters and lessons) will be available
// // //                   after saving the course. For now, chapters are seeded from the constants file on migration.
// // //                 </p>
// // //               </div>
// // //             </div>
// // //           )}
...
// //     setChapters(chs => chs.map((c, i) => {
// //       if (i !== ci) return c;
// //       return { ...c, lessons: c.lessons.map((l, j) => {
// //         if (j !== li) return l;
// //         const k = si + dir;
...
// //                         </span>
// //                         <span style={{flex:1,fontSize:13,color:ch.title?"#1a1208":"#bbb",
...
// //                           {/* lessons */}
// //                           {(ch.lessons || []).map((l, li) => (
// //                             <div key={l.id || li} style={{border:"1px dashed #e2e2de",borderRadius:8,
...
// //                                 <div key={sec.id || si} style={{border:"1px solid #eee",borderRadius:6,
